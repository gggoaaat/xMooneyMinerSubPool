-- Table: MinerData.TempPayout_Archive

-- DROP TABLE "MinerData"."TempPayout_Archive";

CREATE TABLE IF NOT EXISTS "MinerData"."TempPayout_Archive"
(
    "PayOutID" bigint,
...
ALTER TABLE "MinerData"."TempPayout_Archive"
    OWNER to mooney;
-- Index: Index_TempPayout_Archive_ID

-- DROP INDEX "MinerData"."Index_TempPayout_Archive_ID";

CREATE INDEX "Index_TempPayout_Archive_ID"
    ON "MinerData"."TempPayout_Archive" USING btree
